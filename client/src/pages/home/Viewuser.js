...
const Viewuser = () => {
  ...
  const loadAlluser = async (userdata) => {
    await getuser(userdata.token).then((res) => {
      setuser(res.data);
      setloading(true);
    });
  };
  const handlechange = async (e, s) => {
    e.preventDefault();
    const data = { ...s, [e.target.name]: e.target.value };
    await userupdate(user.token, data).then((res) => {
      setloading(false);
      loadAlluser(user);
      console.log(res);
        ...
        <div className="container3">
          ...
          <ul className="responsive-table">
            <li className="table-header">
              ...
              <div className="col col1" style={{ paddingRight: "6vw" }}>
                name
              </div>
            ...
            {users.map((s) => {
              return (
                <li className="table-row">
                  ...
                  <div className="col col6" data-label="role">
                    <select
                      style={{
                        borderRadius: "7px",
                        width: "10vw",
                  ...
                  <div className="col col7" data-label="approved">
                    <select
                      style={{
                        borderRadius: "7px",
                        width: "10vw",
